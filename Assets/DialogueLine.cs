...
public class DialogueLine : MonoBehaviour
{
    ...
    private string stringToAnimate = "Making a {sound:1}dialogue box in Unity 5. {color:red}Let's see if this text animation works.";
    ...
    private IEnumerator AnimateTextCoroutine(string text)
    {
        ...
        dialogueTextPro.text = StripAllCommands(text);
        ...
        int totalCharacters = dialogueTextPro.textInfo.characterCount;

        //Color of all characters' vertices.
        Color32[] newVertexColors;

        //Base color for our text.
        Color32 c0 = dialogueTextPro.color;
        ...
        while (i < totalCharacters)
        {
            ...
            */
            ...
            if (textInfo.characterInfo[i].isVisible)
            {
                ...
                dialogueTextPro.UpdateVertexData(TMP_VertexDataUpdateFlags.Colors32);
            }
